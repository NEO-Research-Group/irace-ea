...
"minMeasurableTime", "digits", "debugLevel", "nbIterations", 
"nbExperimentsPerIteration", "sampleInstances", "testType", "firstTest", 
"eachTest", "minNbSurvival", "nbConfigurations", "mu", "confidence", 
"deterministic", "seed", "parallel", "loadBalancing", "mpi", 
"batchmode", "softRestart", "softRestartThreshold", "testInstancesDir", 
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "ea_variation", 
"de_cr", "de_fscale", "crossover", "mutation", "ga_cross_prob", 
"sbx_eta", "ga_mut_prob", "pm_eta"), type = c("x", "x", "x", 
"p", "p", "p", "p", "p", "p", "s", "x", "p", "p", "p", "x", "p", 
"p", "i", "x", "x", "p", "i", "i", "r", "r", "i", "i", "i", "i", 
"b", "s", "i", "i", "i", "i", "i", "r", "b", "i", "i", "b", "b", 
"s", "b", "r", "p", "p", "x", "i", "b", "b", "i", "i", "x", "b", 
"s", "s", "i", "i", "i", "b", "r", "b", "s", "r", "r", "s", "s", 
"r", "r", "r", "i"), short = c("-h", "-v", "-c", "", "-s", "-p", 
"", "-l", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "-e", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", ""), long = c("--help", "--version", "--check", "--only-test", 
"--scenario", "--parameter-file", "--exec-dir", "--log-file", 
"--recovery-file", "", "", "--train-instances-dir", "--train-instances-file", 
"--configurations-file", "", "--forbidden-file", "--target-runner", 
"--target-runner-retries", "", "", "--target-evaluator", "--max-experiments", 
"--max-time", "--budget-estimation", "--min-measurable-time", 
"--digits", "--debug-level", "--iterations", "--experiments-per-iteration", 
...
"--postselection", "--aclib", "--ea-variation", "--de-cr", "--de-fscale", 
"--crossover", "--mutation", "--ga-cross-prob", "--sbx-eta", 
"--ga-mut-prob", "--pm-eta"), default = c(NA, NA, NA, "", "./scenario.txt", 
"./parameters.txt", "./", "./irace.Rdata", "", "", "", "./Instances", 
"", "", "", "", "./target-runner", "0", "", "", "", "0", "0", 
"0.02", "0.01", "4", "0", "0", "0", "1", "", "5", "1", "0", "0", 
"5", "0.95", "0", NA, "0", "1", "0", "0", "1", "", "", "", "", 
"1", "0", "1", "1", "2", "", "0", "median", "candidate", "0", 
"0", "1", "1", "0", "0", "", "0.5", "0.5", "uniform", "polynomial", 
"0.5", "0.5", "1", "20"), description = c("Show this help.", 
...
"Select the evolutionary variation operator (DE or GA, default is none).", 
"CR paramenter of the differential evolution crossover DE/best/1/bin.", 
"F-scale paramenter of the differential evolution crossover DE/best/1/bin.", 
"Crossover operator.", "Mutation operator.", "Probability of performing crossover.", 
"Parameter of SBX.", "Probability of mutation (actual probability is divided by the number of variable parameters).", 
"eta parameter of polynomial mutation.")), row.names = c(".help", 
".version", ".check", ".onlytest", "scenarioFile", "parameterFile", 
"execDir", "logFile", "recoveryFile", "instances", "initConfigurations", 
"trainInstancesDir", "trainInstancesFile", "configurationsFile", 
"forbiddenExps", "forbiddenFile", "targetRunner", "targetRunnerRetries", 
"targetRunnerData", "targetRunnerParallel", "targetEvaluator", 
"maxExperiments", "maxTime", "budgetEstimation", "minMeasurableTime", 
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "ea_variation", 
"de_cr", "de_fscale", "crossover", "mutation", "ga_cross_prob", 
"sbx_eta", "ga_mut_prob", "pm_eta"), class = "data.frame")
