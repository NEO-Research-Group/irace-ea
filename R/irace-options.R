...
"de_cr", "de_fscale", "ga_cross_prob", "ga_cross_param", "ga_mut_prob", 
"ga_mut_param", "parameters_length"), type = c("x", "x", "x", 
"p", "p", "p", "p", "p", "p", "s", "x", "p", "p", "p", "x", "p", 
"p", "i", "x", "x", "p", "i", "i", "r", "r", "i", "i", "i", "i", 
"b", "s", "i", "i", "i", "i", "i", "r", "b", "i", "i", "b", "b", 
"s", "b", "r", "p", "p", "x", "i", "b", "b", "i", "i", "x", "b", 
"s", "s", "i", "i", "i", "b", "r", "b", "s", "r", "r", "r", "r", 
"r", "i", "i"), short = c("-h", "-v", "-c", "", "-s", "-p", "", 
"-l", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "-e", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
...
"--ga-cross-prob", "--ga-cross-param", "--ga-mut-prob", "--ga-mut-param", 
"--parameters-length"), default = c(NA, NA, NA, "", "./scenario.txt", 
"./parameters.txt", "./", "./irace.Rdata", "", "", "", "./Instances", 
"", "", "", "", "./target-runner", "0", "", "", "", "0", "0", 
"0.02", "0.01", "4", "0", "0", "0", "1", "", "5", "1", "0", "0", 
"5", "0.95", "0", NA, "0", "1", "0", "0", "1", "", "", "", "", 
"1", "0", "1", "1", "2", "", "0", "median", "candidate", "0", 
"0", "1", "1", "0", "0", "", "0.5", "0.5", "0.5", "0.5", "0.1", 
"20", "20"), description = c("Show this help.", "Show irace package version.", 
...
"Probability of performing crossover.", "Parameter of crossover.", 
"Probability of perform a mutation.", "Parameter of mutation.", 
"Parameter for two point crossover.")), row.names = c(".help", 
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "ea_variation", 
"de_cr", "de_fscale", "ga_cross_prob", "ga_cross_param", "ga_mut_prob", 
"ga_mut_param", "parameters_length"), class = "data.frame")
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "ea_variation", 
"de_cr", "de_fscale", "ga_cross_prob", "ga_cross_param", "ga_mut_prob", 
"ga_mut_param", "parameters_length")
