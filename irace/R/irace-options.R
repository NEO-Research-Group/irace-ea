...
"boundPar", "boundAsTimeout", "postselection", "aclib", "ealgorithm", 
"deF", "deCR", "muF", "muCR", "cJade", "probCross", "crossParam", 
"probMut", "mutParam"), type = c("x", "x", "x", "p", "p", "p", 
"p", "p", "p", "s", "p", "p", "p", "x", "p", "p", "i", "x", "x", 
"p", "i", "i", "r", "i", "i", "i", "i", "b", "s", "i", "i", "i", 
"i", "i", "r", "b", "i", "i", "b", "b", "s", "b", "r", "p", "p", 
"x", "i", "b", "b", "i", "i", "x", "b", "s", "s", "i", "i", "i", 
"b", "r", "b", "s", "r", "r", "r", "r", "r", "r", "r", "r", "i"
), short = c("-h", "-v", "-c", "", "-s", "-p", "", "-l", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "-e", "", "", "", "", "", "", "", 
"", "", "", "", "", "-ea", "-deF", "-deCR", "-deF", "-jadeCR", 
"-jadeC", "-gaProbCross", "", "-gaProbMut", ""), long = c("--help", 
...
"--postselection", "--aclib", "--ealgorithm", "--ea-de-f", "--ea-de-cr", 
"--ea-de-f", "--ea-jade-cr", "--ea-jade-c", "--ea-ga-cross-prob", 
"--ea-ga-cross-param", "--ea-ga-mut-prob", "--ea-ga-mut-param"
), default = c(NA, NA, NA, "", "./scenario.txt", "./parameters.txt", 
"./", "./irace.Rdata", "", "", "./Instances", "", "", "", "", 
"./target-runner", "0", "", "", "", "0", "0", "0.02", "4", "0", 
"0", "0", "1", "F-test", "5", "1", "0", "0", "5", "0.95", "0", 
NA, "0", "1", "0", "0", "1", "", "", "", "", "1", "0", "1", "1", 
"2", "", "0", "median", "candidate", "0", "0", "1", "1", "0", 
"0", NA, "0.5", "0.5", "0.5", "0.5", "0.5", "0.5", "0.5", "0.1", 
"20"), description = c("Show this help.", "Show irace package version.", 
...
"Select the evolutionary algorithm to run the sampling.", "F paramenter of the differential evolution crossover DE/best/1/bin.", 
"CR paramenter of the differential evolution crossover DE/best/1/bin.", 
"Initial paramenter F of the algorithm JADE: Adaptive Differential Evolution With Optional External Archive.", 
"Initial paramenter CR of the algorithm JADE: Adaptive Differential Evolution With Optional External Archive.", 
"Paramenter c of the algorithm JADE: Adaptive Differential Evolution With Optional External Archive.", 
"Probability of perform a crossover.", "Parameter of crossover.", 
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "ealgorithm", 
"deF", "deCR", "muF", "muCR", "cJade", "probCross", "crossParam", 
"probMut", "mutParam"), class = "data.frame")
